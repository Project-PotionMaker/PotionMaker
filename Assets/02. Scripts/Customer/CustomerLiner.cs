...
public class CustomerLiner // 접수대 앞에 물리적으로 줄 세우는 컴포넌트
{
    ...
    public void NewCustomerLining(Customer customer) // 새 손님 줄 세우기
    {
        ...
        int viewID = customer.GetComponent<PhotonView>().ViewID;
    ...
    {
        return CustomerManager.Instance.CounterLocation.position + (index * _spacing);
    }
